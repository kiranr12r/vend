...
const inp = (hasError?: string) =>
  `w-full px-3 py-2 border ${hasError ? "border-red-300 bg-red-50 focus:border-red-400 focus:ring-red-50" : "border-gray-200 bg-white focus:border-blue-400 focus:ring-blue-50"} rounded-lg text-xs font-medium text-gray-800 focus:outline-none focus:ring-2 transition-all duration-150 placeholder:text-gray-300`;
    ...
    <div>
      ...
      <div className="p-5 space-y-5">
        ...
        <div>
          ...
          <div className="flex gap-2 items-start p-4 bg-indigo-50/60 border border-indigo-100 rounded-xl">
            <div className="flex-1">
              <label className={lbl}>GST Number <span className="text-red-400">*</span></label>
              <div className="relative">
                <input
                  ...
                  maxLength={15}
                  className={`${inp(errors?.gstNumber)} font-mono tracking-widest pr-9 ${fetched ? "border-emerald-400 bg-emerald-50" : ""}`}
                />
                {fetched && (
              ...
              {fetched && <p className="text-xs text-emerald-600 font-medium mt-1 flex items-center gap-1">
            ...
            <div className="mt-5">
              <button
                ...
                className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-lg transition-all active:scale-95 disabled:opacity-40 flex items-center gap-1.5 whitespace-nowrap shadow-sm"
              >
                {fetching ? (
        ...
        <div>
          ...
          <div
            ...
            className={`mt-4 flex items-center justify-between px-4 py-3 rounded-lg border cursor-pointer select-none transition-all duration-150 ${data.panLinkedAadhaar ? "border-emerald-300 bg-emerald-50" : "border-gray-200 bg-gray-50 hover:border-gray-300"}`}
          >
            <div className="flex items-center gap-3">
              ...
              <span className={`text-xs font-semibold ${data.panLinkedAadhaar ? "text-emerald-700" : "text-gray-600"}`}>PAN Linked with Aadhaar</span>
            </div>
            {data.panLinkedAadhaar && <span className="text-xs bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full font-medium">Verified</span>}
          </div>
        </div>
